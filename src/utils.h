...
#define ATTR(t, name, get, set)                                                \
  Nan::SetAccessor(t->InstanceTemplate(), Nan::New(name).ToLocalChecked(),     \
                   get, set);
...
NAN_INLINE bool NanBooleanOptionValue(v8::Local<v8::Object> optionsObj,
...
// Method removed from NAN
NAN_INLINE uint32_t NanUInt32OptionValue(v8::Local<v8::Object> optionsObj,
